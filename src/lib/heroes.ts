...
const HERO_ROLES: Record<string, Role> = {
  ...
  '무라딘': '탱커', '스티치스': '탱커', '티리엘': '탱커', '바리안': '탱커',
  '정예 타우렌 족장': '탱커', 'E.T.C.': '탱커', 'ETC': '탱커',

  // ── 투사 ──
  '아르타니스': '투사', '첸': '투사', '데하카': '투사', '디바': '투사', 'D.Va': '투사',
  '임페리우스': '투사', '레오릭': '투사', '말티엘': '투사', '라그나로스': '투사',
  '소냐': '투사', '스랄': '투사', '이렐': '투사', '렉사르': '투사', '호거': '투사',
  '데스윙': '투사',

  // ── 암살자 ──
  '겐지': '암살자', '트레이서': '암살자', '일리단': '암살자', '케리건': '암살자',
  '제라툴': '암살자', '사무로': '암살자', '알라라크': '암살자', '발리라': '암살자',
  '도살자': '암살자', '부처': '암살자', '캘타스': '암살자', '제이나': '암살자',
  '리밍': '암살자', '크로미': '암살자', '굴단': '암살자', '한조': '암살자',
  '카시아': '암살자', '캐시아': '암살자', '펜릭스': '암살자', '폴스타트': '암살자',
  '그레이메인': '암살자', '줄진': '암살자', '노바': '암살자', '레이너': '암살자',
  '루나라': '암살자', '메피스토': '암살자', '오르피아': '암살자', '타이커스': '암살자',
  '발라': '암살자', '키히라': '암살자', '마이에브': '암살자', '줄': '암살자',
  '타사다르': '암살자', '실바나스': '암살자', '정크랫': '암살자', '더 부처': '암살자',

  // ── 지원가 ──
  '알렉스트라자': '지원가', '아나': '지원가', '안두인': '지원가', '아우리엘': '지원가',
  '브라이트윙': '지원가', '데커드': '지원가', '카라짐': '지원가', '리리': '지원가',
  '루시우': '지원가', '말퓨리온': '지원가', '모랄레스 중위': '지원가', '레가르': '지원가',
  '스투코프': '지원가', '스터코프': '지원가', '티란데': '지원가', '우서': '지원가',
  '휘트메인': '지원가', '메디브': '지원가', '자리야': '지원가',

  // ── 전문가 ──
  '아바투르': '전문가', '아즈모단': '전문가', '가즈로': '전문가', '머키': '전문가',
  '나지보': '전문가', '프로비우스': '전문가', '해머 상사': '전문가', '해머상사': '전문가',
  '자가라': '전문가', '잃어버린 바이킹': '전문가', '더 로스트 바이킹': '전문가',
};

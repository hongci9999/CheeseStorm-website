      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-5)' }}>
        ...
        <SectionCard accent="var(--cheese-green)">
          ...
          <p style={{
            ...
            언젠가 돌아올 히오스 대회를 대비해 내전 전적을 추적하고, 팀 편성 시 밸런스 참고 자료로 활용합니다.<br />
            이 사이트에 등록된 스트리머는 스트리머 권한을 얻으며 다른 사람을 초대하고 경기를 기록하는 등의 권한을 얻습니다.
          </p>
        ...
        <SectionCard accent="var(--tier-b)">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-4)', marginTop: 'var(--sp-6)' }}>
            <Step
              num={2}
              title="스트리머 추가/삭제/수정 (관리자 전용)"
              desc="관리자 권한으로 로그인하면 스트리머 추가 양식이 나타납니다. 치지직 채널 ID와 이름으로 등록하며, 각 카드 우측 상단에 수정·삭제 버튼이 나타납니다."
            />
          </div>
        </SectionCard>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-4)' }}>
            {[
              ...
              },
              {
                ...
                desc: 'streamers 컬렉션에 등록된 치지직 계정으로 로그인하면 자동 부여됩니다. 스트리머 추가, 경기 입력과 큐레이션 티어 편집이 가능합니다.',
              },
              {
                role: '운영자',
                color: 'var(--tier-s)',
                desc: '관리자 계정입니다. 스트리머 추가/삭제, 경기 삭제, 큐레이션 티어 편집 등 모든 권한을 가집니다.',
              },
            ].map(({ role, color, desc }) => (
              <div
                key={role}
